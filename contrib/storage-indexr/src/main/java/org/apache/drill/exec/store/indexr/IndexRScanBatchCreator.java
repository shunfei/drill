...
public class IndexRScanBatchCreator implements BatchCreator<IndexRSubScan> {
  ...
  @Override
  public ScanBatch getBatch(ExecutorFragmentContext context, IndexRSubScan subScan, List<RecordBatch> children) throws ExecutionSetupException {
    ...
    return new ScanBatch(subScan, context, assignReaders);
  }
